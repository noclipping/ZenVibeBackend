  ...
  async (req, res) => {
    ...
    try {
      ...
      if (data.choices && data.choices.length > 0 && data.choices[0].message) {
        ...
        await pool.query(
          "INSERT INTO conversation_history (user_id, timestamp, role, message_content) VALUES ($1, $2, $3, $4)",
          [req.user.user_id, timestamp, "user", userMessage]
        );
        await pool.query(
          "INSERT INTO conversation_history (user_id, timestamp, role, message_content) VALUES ($1, $2, $3, $4)",
          [req.user.user_id, timestamp, "assistant", replyMessage]
        );
      } else {
