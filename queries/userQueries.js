...
const updateUser = async (req, res) => {
    ...
    const { username, password_hash, email, original_weight, feet, inches, height_inches, age, goal_weight } = req.body
...
const result = await db.pool.query(
   `UPDATE users SET username = $1, password_hash = $2, email = $3, original_weight = $4, feet = $5, inches = $6, height_inches = $7, age = $8, goal_weight = $9 WHERE user_id = ${req.params.id} RETURNING *`,
